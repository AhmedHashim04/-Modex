    ...
    phone_number = forms.CharField(
        ...
        validators=[
            RegexValidator(
                ...
                message=_(
                    "Enter a valid Egyptian phone number starting with 010, 011, 012, or 015."
                ),
            )
        ],
        label=_("Phone Number"),
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": _("e.g. 01012345678")}
        ),
        help_text=_(
            "Enter your 11-digit Egyptian phone number starting with 010, 011, 012, or 015."
        ),
    )
