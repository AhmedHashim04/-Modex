...
class Profile(models.Model):
    ...
    phone_number = models.CharField(
        ...
        validators=[
            RegexValidator(
                ...
                message=_("Enter a valid Egyptian phone number"),
            )
        ],
    )
    city = models.CharField(
        _("City"), choices=Cities.choices, max_length=100, blank=True, null=True
    )
    ...
    address = models.CharField(
        ...
        validators=[
            RegexValidator(
                ...
                message=_("Enter a valid Egyptian Address in Arabic"),
            )
        ],
        max_length=255,
        blank=True,
    ...
    postal_code = models.CharField(
        ...
        validators=[
            RegexValidator(
                ...
                message=_("Enter a valid Egyptian Postal Code"),
            )
        ],
        max_length=10,
        blank=True,
    ...
    activation_key = models.CharField(
        _("Activation Key"), max_length=255, blank=True, null=True
    )
    activation_key_expires = models.DateTimeField(
        _("Activation Key Expires"), blank=True, null=True
    )
