...
class Product(models.Model):
    ...
    discount = models.DecimalField(max_digits=5,decimal_places=2,default=0,verbose_name=_("Discount"),
                                help_text=_("Discount percentage (0-100)"),validators=[MinValueValidator(0), MaxValueValidator(100)])
    ...
    def price_after_discount(self):
        return self.price * (Decimal(100) - self.discount) / Decimal(100).quantize(Decimal('.01'))
    ...
    def save(self, *args, **kwargs):
        ...
        try:
            ...
            self.slug = generate_product_slug(self.name + str(timezone.now().timestamp()))
...
class Category(models.Model):
    ...
    parent = models.ForeignKey('self', limit_choices_to={'parent__isnull': True}, on_delete=models.PROTECT,
                                verbose_name=_("Parent Category"), blank=True, null=True, related_name='children')
    description = models.TextField(max_length=1000, verbose_name=_("Description"))
